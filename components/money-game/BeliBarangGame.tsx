...
import { rupiahDenominations, Item, Screen, GameType } from "@/components/type/MoneyGame"
...
export function BeliBarangGameContent({
  currentItem,
  selectedCoins,
  onResetCoins,
  onCoinClick,
    ...
    <div className="flex flex-col h-full gap-3">
      ...
      <div className="bg-white p-4 rounded-xl shadow-md border-2 border-blue-300 text-center">
        ...
        <p className="text-3xl font-extrabold text-blue-600 bg-blue-50 rounded-lg py-1">
          {formatRupiah(currentItem.price || 0)}
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-3 rounded-xl border border-blue-200">
        <div className="flex justify-between items-center mb-2">
          ...
          {currentScreen === "practice-game" && (
            <p className={`text-lg font-bold ${currentTotal > (currentItem.price || 0) ? "text-red-600" : "text-blue-700"
              }`}>
